    ...
    public static class BuildCompilerScript
    {
        public static void BuildCompiler(BuildSettingsData buildSettings)
        {
            try
            {
                ...
                string removeBuildScriptsPath = $"rmdir \"{compileScriptsDir.Replace("/", "\\")}\" /q /s";
                string removeBuildScriptsCommand = (buildSettings.includeBuildScripts == true) ? string.Empty : removeBuildScriptsPath;
