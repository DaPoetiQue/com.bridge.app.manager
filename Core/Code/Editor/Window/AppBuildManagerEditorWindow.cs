...
namespace Bridge.Core.UnityEditor.App.Manager
{
    public class AppBuildManagerEditorWindow : EditorWindow
    {
        ...
        private static void CreateBuildCompiler()
        {
            ...
            string projectDir = info.DirectoryName;
            string directory = projectDir + "/Compiler";
            ...
            string excludedFolders = "/E /xd Compiler Library Temp Build Builds Obj Logs UserSettings MemoryCaptures";
